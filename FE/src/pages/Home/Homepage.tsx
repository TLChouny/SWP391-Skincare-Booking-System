    ...
    <Layout>
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center text-center text-white px-6">
          ...
          <motion.button
            onClick={() => services.length > 0 && handleBookNow(services[0]._id)} // Chọn _id của service đầu tiên nếu có
              ...
              services.slice(currentServiceIndex * 3, (currentServiceIndex + 1) * 3).map((service) => (
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "/default-service.jpg"; // Fallback nếu ảnh lỗi
                    }}
                  />
                  <div className="p-8">
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <div className="flex flex-col">
                        <span className="text-2xl font-bold text-yellow-500">
                          {service.price ? `$${service.price / 100000}` : "Contact for Price"}
                        </span>
