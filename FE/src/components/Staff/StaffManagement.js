...
import { ClockCircleOutlined, HistoryOutlined, ScheduleOutlined, } from "@ant-design/icons";
...
const items = [
    getItem("StaffBooking", "/staff/staffBooking", _jsx(ScheduleOutlined, {})),
    getItem("StaffPayment", "/staff/staffPayment", _jsx(ClockCircleOutlined, {})),
    getItem("StaffService", "/staff/staffService", _jsx(HistoryOutlined, {})),
];
