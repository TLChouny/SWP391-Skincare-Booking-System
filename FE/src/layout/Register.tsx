      ...
      <div className="flex justify-center flex-1 max-w-screen-lg bg-white border shadow sm:rounded-lg">
        <div className="flex-1 hidden text-center md:flex">
          <img
            src={logo}
            alt="logo"
            className="m-5 w-108 h-108 object-contain rounded-lg" // Điều chỉnh kích thước logo hợp lý hơn
          />
        </div>
            ...
            <form onSubmit={handleSubmit} className="flex-1 w-full">
              <div className="flex flex-col max-w-xs gap-3 mx-auto">
                ...
                <div className="relative w-full">
                  ...
                  <button
                    type="button"
                    className="absolute text-gray-500 right-3 top-2.5"
                ...
                <select
                  className="w-full px-4 py-2 text-sm font-medium bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-400 focus:bg-white"
                  name="gender"
